...
#include "BehaviorTree/CBTService_TwoPhase.h"
#include "Global.h"
...
UCBTService_TwoPhase::UCBTService_TwoPhase()
{
	NodeName = "TwoPhase";
...
void UCBTService_TwoPhase::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
